...
#define CUSTOM_MACHINE_NAME "Ramps1.4 i3" //RAMPS 1.4 - Duplicator i3 (Maker Select V2.1)
 ...
 */
#define DEFAULT_XJERK                  6.0 //old custom val was 8.0
#define DEFAULT_YJERK                  6.0 //old custom val was 8.0 
